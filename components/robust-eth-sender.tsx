...
export function RobustETHSender() {
  ...
  // Robust ETH transfer with proper gas handling
  const sendETH = async () => {
    ...
    try {
      ...
      if (receipt && receipt.status === '0x1') {
        ...
        toast({
          ...
          description: "Transaction sent but confirmation is taking longer than expected",
        })
      }
